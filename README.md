...
![screenshoot](./.assets/screenshoot-1.png)

![screenshoot](./.assets/screenshoot-2.png)
> [!IMPORTANT]
...
3. 访问应用
    打开浏览器访问：`http://localhost:7410`.如果是局域网其他电脑访问，请使用服务器 IP，例如 `http://192.168.1.100:7410`
...
## 现存问题
1. Token过期后不会有提示,上传文件等操作不会有反应,需要退出重新登陆账号.
